...
RUN apt-get update -qq && apt-get install -yq --no-install-recommends psmisc libapparmor1 sudo r-recommended libssl1.0.0 \
    && apt-get clean \
    && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
...
# User-defined instruction
RUN mkdir repos && cd repos && git clone https://github.com/neuro-data-science/neuroviz.git && git clone https://github.com/neuro-data-science/neuroML.git && git clone https://github.com/ReproNim/reproducible-imaging.git && git clone https://github.com/miykael/nipype_tutorial.git
