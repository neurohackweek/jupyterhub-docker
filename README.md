...
--user=neuro \
--miniconda python_version=3.6 conda_install="python=3.6 jupyter jupyterlab traits pandas matplotlib scikit-learn seaborn swig reprozip reprounzip altair traitsui apptools configobj vtk jupyter_contrib_nbextensions bokeh scikit-image codecov nitime cython joblib jupyterhub=0.7.2" \
            env_name="neuro" \
add_to_path=True \
...
--miniconda python_version=2.7 env_name="afni27" \
...
--instruction "RUN echo 'neuro:neuro' | chpasswd" \
--user=neuro \
